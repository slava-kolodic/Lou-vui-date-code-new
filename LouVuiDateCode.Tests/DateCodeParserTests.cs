...
namespace LouVuiDateCode.Tests
{
    ...
    public sealed class DateCodeParserTests
    {
        ...
        {
            // Act
            DateCodeParser.ParseEarly1980Code(dateCode, out uint actualProductionYear, out uint actualProductionWeek);

            // Assert
            Assert.AreEqual(expectedProductionYear, actualProductionYear);
            Assert.AreEqual(expectedProductionMonth, actualProductionWeek);
        }
        ...
        {
            // Act
            DateCodeParser.ParseLate1980Code(dateCode, out Country[] actualCountries, out string actualFactoryLocationCode, out uint actualProductionYear, out uint actualProductionWeek);
        ...
        {
            // Act
            DateCodeParser.Parse1990Code(dateCode, out Country[] actualCountries, out string actualFactoryLocationCode, out uint actualProductionYear, out uint actualProductionWeek);
        ...
        public void Parse2007Code_DateCodeIsValid_ReturnsResult(string dateCode, Country[] expectedCountries, string expectedFactoryLocationCode, uint expectedProductionYear, uint expectedProductionMonth)
        {
            // Act
